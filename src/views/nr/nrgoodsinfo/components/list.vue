          ...
          <el-row class="homeMainTableSearch">
            ...
            <el-col :span="18">
              <el-form :inline="true" :model="formInline" class="homeMainRowRightForm">
                <el-form-item> <!-- ==============todo 2===============-->
                  <el-input size="mini" v-model="formInline.goodsname" placeholder="请输入商品名称"></el-input>
                </el-form-item>
                <el-form-item>
