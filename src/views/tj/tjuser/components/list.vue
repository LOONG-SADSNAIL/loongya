      ...
      <el-col class="homeMainRowColRight" :span="20">
          <div class="homeMainRowColRightTable">
            <el-row>
              ...
              <!--<el-col :span="2">
                <el-button class="buttonaddclass" size="mini" type="primary" @click="out">导出当前数据</el-button>
              </el-col>
              <el-col :span="2">
                <el-button class="buttonaddclass" size="mini" type="primary" @click="enter">导入用户</el-button>
              </el-col>-->
              <!--==================================列表查询===========start===================================== -->
              <el-col :span="18">
                <el-form :inline="true" :model="formInline" class="homeMainRowRightForm">
                  <el-form-item>
                    <el-input v-model="formInline.nickName" placeholder="请输入用户姓名"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-input v-model="formInline.mobile" placeholder="请输入用户电话号码"></el-input>
                  </el-form-item>
                  <el-form-item>
...
<script>
import { list } from '@/api/tj/tjuser'
