          ...
          <el-row class="homeMainTableSearch">
            ...
            <el-col :span="20">
              <el-form :inline="true" :model="formInline" class="homeMainRowRightForm">
                <el-form-item>
                  <el-input  size="mini" v-model="formInline.orderNo" placeholder="请输入订单号"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
import { list } from '@/api/tj/tjwithdrawdetail'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import TjWithdrawDetailEdit from './edit/tjWithdrawDetailEdit'
export default {
  name: 'TjWithdrawDetailList',
  components: {
    OrganTreeList,
    TjWithdrawDetailEdit
  },
