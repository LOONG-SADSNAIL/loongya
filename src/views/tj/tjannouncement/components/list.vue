...
<script>
// ==============todo5
import { list } from '@/api/tj/tjannouncement'
import TjAnnounCementEdit from './edit/tjAnnounCementEdit'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import AddTjAnnounCement from './edit/add'
export default {
  name: 'TjAnnounCementList',
  components: { // ==============todo6
    OrganTreeList,
    TjAnnounCementEdit,
    AddTjAnnounCement
