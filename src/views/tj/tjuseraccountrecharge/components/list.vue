...
<script>
import { list } from '@/api/tj/tjuseraccount'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import TjUserAccountRechargeEdit from './edit/tjUserAccountRechargeEdit'
export default {
  name: 'TjUserAccountRechargeList',
  components: {
    OrganTreeList,
    TjUserAccountRechargeEdit
  },
