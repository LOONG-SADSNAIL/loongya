          ...
          <el-row class="homeMainTableSearch">
            ...
            <el-col :span="18">
              <el-form :inline="true" :model="formInline" class="homeMainRowRightForm">
                <el-form-item> <!-- ==============todo 2===============-->
                  <el-input size="mini" v-model="formInline.contacttel" placeholder="请输入保修电话"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
// ==============todo5
import { list } from '@/api/hw/hwrepairinfo'
import HwRepairInfoEdit from './edit/hwRepairInfoEdit'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import EditModel from './edit/add'
export default {
  name: 'HwRepairInfoList',
  components: { // ==============todo6
    OrganTreeList,
    HwRepairInfoEdit,
    EditModel
