          ...
          <el-row class="homeMainTableSearch">
            ...
            <el-col :span="18">
              <el-form :inline="true" :model="formInline" class="homeMainRowRightForm">
                <el-form-item> <!-- ==============todo 2===============-->
                  <el-input size="mini" v-model="formInline.goodsname" placeholder="请输入回收物价格"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
// ==============todo5
import { list } from '@/api/hw/hwrecoverypriceinfo'
import HwRecoveryPriceInfoEdit from './edit/hwRecoveryPriceInfoEdit'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import EditModel from './edit/add'
export default {
  name: 'HwRecoveryPriceInfoList',
  components: { // ==============todo6
    OrganTreeList,
    HwRecoveryPriceInfoEdit,
    EditModel
