...
<script>
// ==============todo5
import { list } from '@/api/hw/hwreplenishmentinfo'
import HwReplenishmentInfoEdit from './edit/hwReplenishmentInfoEdit'
import OrganTreeList from '@/views/system/sysbaseorgan/components/organTreeList'
import AddReplenishMent from './edit/add'
export default {
  name: 'SysNoticeList',
  components: { // ==============todo6
    OrganTreeList,
